...
function totalWorkJob(startWork, endWork, company) {
    ...
    if(endWork.innerText == "Present"){
        ...
        if((yearNow - yearStart) == 0){
            document.querySelector(whichCompanyIs()).innerText = `${monthNow - monthStart} months`;
            ...
            if((yearNow - yearStart == 1) && (monthStart-monthNow > 0)){
                ...
                document.querySelector(whichCompanyIs()).innerText = `${totalMothsOfWork} months`;
                return;
            }

            if((yearNow - yearStart > 1) && (monthStart-monthNow > 0)){
                let totalMothsOfWork = (12 - monthStart) + monthNow;
                document.querySelector(whichCompanyIs()).innerText = `${yearNow-yearStart-1} years and ${totalMothsOfWork} months`;
                return;
            }

            if((monthStart-monthNow) == 0){
                document.querySelector(whichCompanyIs()).innerText = `${yearNow-yearStart} years`;
                return;
            }
            
            if((monthStart-monthNow) < 0){
                document.querySelector(whichCompanyIs()).innerText = `${yearNow-yearStart} years and ${monthNow-monthStart} months`;
                return;
            }
        ...
        if((yearEnd - yearStart) == 0){
            document.querySelector(whichCompanyIs()).innerText = `${monthEnd - monthStart} months`;
            return;
            ...
            if((yearEnd - yearStart > 1) && (monthStart-monthEnd > 0)){
                let totalMothsOfWork = (12 - monthStart) + monthEnd;
                document.querySelector(whichCompanyIs()).innerText = `${yearEnd-yearStart-1} years and ${totalMothsOfWork} months`;
                return;
            }

            if((monthStart-monthEnd) == 0){
                document.querySelector(whichCompanyIs()).innerText = `${yearEnd-yearStart} years`;
                return;
            }
            
            if((monthStart-monthEnd) < 0){
                document.querySelector(whichCompanyIs()).innerText = `${yearEnd-yearStart} years and ${monthEnd-monthStart} months`;
                return;
            }
        }
